...
\lstinputlisting[language=Matlab, caption={Returns the negative distance travelled for a given \texttt{theta}.}, label={lst:distance}]{Distance.m}
...
\lstinputlisting[language=Matlab, caption={Returns the height and flight time at 12000m for given \texttt{theta}.},label={lst:heightduration}]{GetHeightAndDurationAt12K.m}

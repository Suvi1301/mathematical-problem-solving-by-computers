function return_prob = ReturningLikelihoodPlot()
...
histogram(likelihood, 'NumBins', 20, 'BinLimits', [0 100], 'Linewidth', 2)
xlabel('Likelihood (%)', 'Fontsize', 14, 'fontname', 'times roman');
ylabel('No. of Customers', 'Fontsize', 14, 'fontname', 'times roman');
ylim([0,14]);
